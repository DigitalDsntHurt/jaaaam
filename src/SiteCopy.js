const fantasiesText = () => (
    <>
        ...
        <p>
            But you don't need to be an Olympian, a soldier or a ballerina. You don't need to be muscular, limber or thin to be healthy. You don't need to want to model yourself on someone else's ideas of beauty, strength or freedom.
        </p>
        <p>
...
const practiceText = () => (
    <>
        ...
        <p>
            Most of all, seek fun and pleasure. Not stories about fun and pleasure but the real thing. Felt by you in your body. <strong>It is possible to forge a personal practice that feels fun and pleasurable forever</strong>.
        </p>
        <p>
            Inspired by Tai-Chi, Qigong, Yoga, Calisthenics, Somatics, The Feldenkrais Method, The Ido Portal Method, improvisational dance modalities, weight sharing games, mindfulness and beautiful movement communities and teachers around the world, this practice works with the material of the body to teach and learn about creativity, spontaneity, compassion and self love. (We also do a lot of just plain goofin' around).
        </p>
        <p>
            Get in touch for a free consultation and introductory movement session by emailing <a href='mailto:grapesdance@gmail.com'>grapesdance@gmail.com</a>.
        </p>
    </>
);
